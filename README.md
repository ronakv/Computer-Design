...
Using the chips designed in the previous section, a 16 bit Adder is first built to add two signals of 16 bits. Following this, an entire 16-bit ALU is designed to perform 18 operations, +/-, AND/OR, incrememnt, AND/OR on two 16 bit inputs.
